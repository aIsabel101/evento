...
class UserController extends Controller
{
    ...
    public function actionLogin()
    {
        if (!\Yii::$app->user->isGuest) {
            echo json_encode(['status' => 1, 'code' => 200, 'user' => Yii::$app->user->identity->username], JSON_PRETTY_PRINT);
        ...
        {
            echo json_encode(['status' => 0, 'code' => 200, 'message' => 'Attempt Succcessful'], JSON_PRETTY_PRINT);
    ...
    {
        ///regisatrar asistencia
        $this->getHeader(200);
        echo json_encode(['status' => 1, 'data' => $id], JSON_PRETTY_PRINT);
        exit;   }
